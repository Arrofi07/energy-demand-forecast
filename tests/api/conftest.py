"""Shared fixtures for the API test suite. Mirrors tests/pipeline/conftest.py's
feature_df / make_tiny_bundle fixtures -- kept local rather than shared
across the two test packages, consistent with this project's existing
per-directory fixture convention (e.g. tests/models/test_lightgbm_direct.py's
own local feature_df).
"""
